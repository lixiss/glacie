...
namespace Glacie.Text
{
    public ref partial struct ValueStringBuilder // : IDisposable
    {
        ...
        {
            DebugCheck.That(additionalCapacityBeyondPos > 0);
            DebugCheck.That(_pos > _chars.Length - additionalCapacityBeyondPos, "Grow called incorrectly, no resize is needed.");
